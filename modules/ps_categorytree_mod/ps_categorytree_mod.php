...
class Ps_CategoryTree_Mod extends Module implements WidgetInterface
{
    public function __construct()
    {
        $this->name = 'ps_categorytree_mod';
        ...
        $this->displayName = $this->getTranslator()->trans('Category tree links mod', array(), 'Modules.Categorytree.Admin');
    ...
    public function install()
    {
        return parent::install()
            ...
            && $this->registerHook('customcategories')
        ;
    }
    ...
    public function renderWidget($hookName = null, array $configuration = [])
    {
        ...
        return $this->fetch('module:ps_categorytree_mod/views/templates/hook/ps_categorytree.tpl');
    }
    
    public function hookcustomcategories(array $configuration = [])
    {
        //$this->setLastVisitedCategory();
        $this->smarty->assign($this->getWidgetVariablesCustom('customcategories', $configuration));
        return $this->fetch('module:ps_categorytree_mod/views/templates/hook/customcategories.tpl');
    }
    
    public function getWidgetVariablesCustom($hookName = null, array $configuration = [])
    {
        $category = new Category((int)Configuration::get('PS_HOME_CATEGORY'), $this->context->language->id);
        return [
            'categories_custom' => $this->getCategories($category),
