                ...
                if (Combination::isFeatureActive() && $item['attribute_related']) 
                {
                    ...
                    else 
                    {
                        $product = array(
                            ...
                            'image' => str_replace('http://', Tools::getShopProtocol(), $context->link->getImageLink($item['link_rewrite'], $item['id_image'], ImageType::getFormatedName('home'))),
                        );
