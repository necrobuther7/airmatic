...
class __TwigTemplate_3aeff758e498a962a5f6a18513bfb93094cb0592212b20a9d3d1db897ec84a9b extends Template
{
    private $source;
    private $macros = [];
            ...
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["product"], "combinations", [], "any", false, false, false, 61))) {
              ...
              <thead>
                ...
                echo "</th>
                  <th>";
                // line 67
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("EAN13", [], "Admin.Catalog.Feature"), "html", null, true);
                echo "</th>
                  <th>";
                // line 68
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Catalog/Manufacturer/Blocks/View/products.html.twig", "C:\\xampp\\htdocs\\airmatic\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Catalog\\Manufacturer\\Blocks\\View\\products.html.twig");
    }
}
