  ...
  {if !$configuration.is_catalog}
    <div class="card card-block">
      ...
      <form method="post" action="{$product.url|escape:'html':'UTF-8'}" enctype="multipart/form-data">
            ...
            <li class="product-customization-item">
              ...
              {elseif $field.type == 'image'}
                {if $field.is_customized}
                  ...
                  <a class="remove-image" href="{$field.remove_image_url|escape:'html':'UTF-8'}" rel="nofollow">{l s='Remove Image' d='Shop.Theme.Catalog'}</a>
                {/if}
                <span class="custom-file">
                  ...
                  <button class="btn btn-primary">{l s='Choose file' d='Shop.Theme.Catalog'}</button>
                </span>
        ...
        <div class="clearfix">
          <button class="btn btn-primary pull-xs-right" type="submit" name="submitCustomizedData">{l s='Save Customization' d='Shop.Theme.Catalog'}</button>
        </div>
      </form>
    </div>
  {/if}
