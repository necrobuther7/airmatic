              ...
              {block name='product_buy'}
                <form action="{$urls.pages.cart|escape:'html':'UTF-8'}" method="post" id="add-to-cart-or-refresh">
                  ...
                  {block name='product_refresh'}
                    <input class="product-refresh ps-hidden-by-js" name="refresh" type="submit" value="{l s='Refresh' d='Shop.Theme.Catalog'}">
                  {/block}
                </form>
              {/block}
             ...
             {if $product.attachments}
              <div class="tab-pane fade in" id="attachments">
                 <section class="product-attachments">
                   <h3 class="h5 text-uppercase">{l s='Download' d='Shop.Theme.Catalog'}</h3>
                   {foreach from=$product.attachments item=attachment}
                     <div class="attachment">
                       ...
                       <a href="{url entity='attachment' params=['id_attachment' => $attachment.id_attachment]}">
                         {l s='Download' d='Shop.Theme.Catalog'} ({$attachment.file_size_formatted|escape:'html':'UTF-8'})
                       </a>
                     </div>
                   {/foreach}
                 </section>
      ...
      {if $accessories}
        <section class="product-accessories col-md-12 col-xs-12">
          <h3 class="h1 products-section-title text-uppercase">
            <i class="fa fa-sliders"></i><span>{l s='You might also like' d='Shop.Theme.Catalog'}</span>
          </h3>
