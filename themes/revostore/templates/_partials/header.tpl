            ...
            <div class="right-nav">
                ...
                <div class="toogle_nav_right">
                    ...
                    {if isset($tc_config.YBC_TC_TRACK_ORDER) && $tc_config.YBC_TC_TRACK_ORDER == 1}
    					<a class="nav_link" href="{$link->getPageLink('history', true)|escape:'html':'UTF-8'}" title="{l s='Track your order' d='Shop.Theme.Action'}">
...
{block name='header_top'}
  ...
  <div class="header-top">
    ...
    <div class="menu_and_cattree">
        <div class="container">
            <div class="row">
             {if isset($tc_config.YBC_TC_ENABLE_CATE_BLOCK) && $tc_config.YBC_TC_ENABLE_CATE_BLOCK}
