  ...
  <div class="card-block">
    ...
    {block name='cart_summary_products'}
      <div class="cart-summary-products">
        ...
        <h4 class="title_summary">{l s='Shopping Cart:' d='Shop.Theme.Checkout'}<span>{$cart.summary_string|escape:'html':'UTF-8'}</span></h4>

        {*<p>
          <a href="#" data-toggle="collapse" data-target="#cart-summary-product-list">
            {l s='show details' d='Shop.Theme.Checkout'}
          </a>
        </p>*}
