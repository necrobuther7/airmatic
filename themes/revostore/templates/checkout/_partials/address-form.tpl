...
{block name='form_buttons'}
  {if !$form_has_continue_button}
    <button type="submit" class="btn btn-primary pull-xs-right">{l s='Save' d='Shop.Theme.Checkout'}</button>
    <a class="js-cancel-address cancel-address pull-xs-right" href="?cancelAddress={$type|escape:'html':'UTF-8'}">{l s='Cancel' d='Shop.Theme.Checkout'}</a>
  {else}
    <form>
