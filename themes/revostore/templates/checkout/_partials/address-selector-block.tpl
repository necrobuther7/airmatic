  ...
  >
    ...
    <footer class="address-footer">
      {if $interactive}
        ...
        >
          <i class="material-icons edit">&#xE254;</i>{l s='Edit' d='Shop.Theme.Checkout'}
        </a>
        <a
        ...
        >
          <i class="material-icons delete">&#xE872;</i>{l s='Delete' d='Shop.Theme.Checkout'}
        </a>
      {/if}
    </footer>
  </article>
...
{if $interactive}
  <p>
    <button class="ps-hidden-by-js form-control-submit center-block" type="submit">{l s='Save' d='Shop.Theme.Checkout'}</button>
  </p>
{/if}
