...
<section id="ybc_social_block" class="ybc_social_config">
    <h4 style="display: none;">{l s='Social' d='Shop.Theme.Actions'}</h4>
	<ul>
		{if isset($facebook_url) && $facebook_url != ''}
			<li class="facebook">
				<a class="_blank" href="{$facebook_url|escape:'html':'UTF-8'}">
					<span><i class="icon-facebook"></i>{l s='Facebook' d='Shop.Theme.Actions'}</span>
				</a>
			</li>
		{/if}
		{if isset($twitter_url) && $twitter_url != ''}
			<li class="twitter">
				<a class="_blank" href="{$twitter_url|escape:'html':'UTF-8'}">
					<span><i class="icon-twitter"></i>{l s='Twitter' d='Shop.Theme.Actions'}</span>
				</a>
			</li>
		{/if}
        {if isset($google_plus_url) && $google_plus_url != ''}
        	<li class="google-plus">
        		<a class="_blank" href="{$google_plus_url|escape:'html':'UTF-8'}" rel="publisher">
        			<span><i class="icon-google-plus"></i>{l s='Google Plus' d='Shop.Theme.Actions'}</span>
        		</a>
        	</li>
        {/if}
        {if isset($linkedin_url) && $linkedin_url != ''}
			<li class="linkedin">
				<a class="_blank" href="{$linkedin_url|escape:'html':'UTF-8'}">
					<span><i class="icon-linkedin" ></i>{l s='Linkedin' d='Shop.Theme.Actions'}</span>
				</a>
			</li>
		{/if}
		{if isset($rss_url) && $rss_url != ''}
			<li class="rss">
				<a class="_blank" href="{$rss_url|escape:'html':'UTF-8'}">
					<span><i class="icon-rss"></i>{l s='RSS' d='Shop.Theme.Actions'}</span>
				</a>
			</li>
		{/if}
        {if isset($youtube_url) && $youtube_url != ''}
        	<li class="youtube">
        		<a class="_blank" href="{$youtube_url|escape:'html':'UTF-8'}">
        			<span><i class="icon-youtube"></i>{l s='Youtube' d='Shop.Theme.Actions'}</span>
        		</a>
        	</li>
        {/if}
        ...
        {if isset($pinterest_url) && $pinterest_url != ''}
        	<li class="pinterest">
        		<a class="_blank" href="{$pinterest_url|escape:'html':'UTF-8'}">
        			<span><i class="icon-pinterest-p"></i>{l s='Pinterest' d='Shop.Theme.Actions'}</span>
        		</a>
        	</li>
        {/if}
        {if isset($vimeo_url) && $vimeo_url != ''}
        	<li class="vimeo">
        		<a class="_blank" href="{$vimeo_url|escape:'html':'UTF-8'}">
        			<span><i class="icon-vimeo-square"></i>{l s='Vimeo' d='Shop.Theme.Actions'}</span>
        		</a>
        	</li>
        {/if}
        {if isset($instagram_url) && $instagram_url != ''}
        	<li class="instagram">
        		<a class="_blank" href="{$instagram_url|escape:'html':'UTF-8'}">
        			<span><i class="icon-instagram" ></i>{l s='Instagram' d='Shop.Theme.Actions'}</span>
        		</a>
        	</li>
        {/if}
	</ul>
