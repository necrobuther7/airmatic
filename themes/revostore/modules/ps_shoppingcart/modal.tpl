        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="cart-content">
              ...
              <button type="button" class="btn btn-secondary" data-dismiss="modal">{l s='Continue shopping' d='Shop.Theme.Checkout'}</button>
              <a href="{$cart_url|escape:'html':'UTF-8'}" class="btn btn-primary"><i class="material-icons">&#xE876;</i>{l s='proceed to checkout' d='Shop.Theme.Checkout'}</a>
            </div>
          </div>
        </div>
      </div>
