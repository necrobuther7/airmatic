    ...
    {if $blog_post}
                ...
                <div class="ybc-blog-latest-toolbar">
                    ...
                    {if $show_date}
                        ...
                        <span class="post-date">
                            <span class="be-label">{l s='Posted on' d='Shop.Theme.Actions'}: </span>
                    ...
                    {if $show_author && ($blog_post.firstname || $blog_post.lastname)}
                        <div class="author-block">
                            <span class="post-author-label">{l s='Posted by: ' d='Shop.Theme.Actions'}</span>
                        ...
                        <ul class="blog-comments-list">
                            {foreach from=$comments item='comment'}
                                    ...
                                    <div class="ybc-blog-detail-comment">
                                        ...
                                        {if $comment.firstname || $comment.lastname}<span class="comment-by">{l s='By : ' d='Shop.Theme.Actions'}<b>{ucfirst($comment.firstname)|escape:'html':'UTF-8'} {ucfirst($comment.lastname)|escape:'html':'UTF-8'}</b></span>{/if}
                                        ...
                                        {if $allow_report_comment && $hasLoggedIn}
                                            {if !($reportedComments && is_array($reportedComments) && in_array($comment.id_comment, $reportedComments))}
                                                <span class="ybc-block-comment-report comment-report-{$comment.id_comment|intval}" rel="{$comment.id_comment|intval}">{l s='Report abuse' d='Shop.Theme.Actions'}</span>
                                            {/if}
                                        {/if}
        ...
        {if $blog_post.related_posts}
            <div class="ybc-blog-related-posts ybc_blog_free_related_posts_type_{if $blog_related_posts_type}{$blog_related_posts_type|escape:'html':'UTF-8'}{else}default{/if}">
                <h4 class="title_blog">{l s='Related posts' d='Shop.Theme.Actions'}</h4>
