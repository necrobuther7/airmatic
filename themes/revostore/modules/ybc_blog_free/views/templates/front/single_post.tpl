            ...
            <div id="content-wrapper" class="{if isset($blog_config.YBC_BLOG_FREE_SIDEBAR_POSITION) && $blog_config.YBC_BLOG_FREE_SIDEBAR_POSITION=='left'}left-column col-xs-12 col-sm-8 col-md-9{elseif isset($blog_config.YBC_BLOG_FREE_SIDEBAR_POSITION) && $blog_config.YBC_BLOG_FREE_SIDEBAR_POSITION=='right'}right-column col-xs-12 col-sm-8 col-md-9 {else} col-xs-12 col-sm-12{/if}">
              {block name="content"}
                ...
                <script type="text/javascript">
                    ...
                    ybc_blog_free_report_warning = '{l s='Do you want to report this comment?' d='Shop.Theme.Actions'}';
                    ybc_blog_free_error = '{l s='There was a problem while submitting your report. Try again later' d='Shop.Theme.Actions'}';                    
                </script>
                <div class="ybc_blog_free_layout_{$blog_layout|escape:'html':'UTF-8'} ybc-blog-wrapper-detail" itemscope itemType="http://schema.org/BlogPosting">
                    ...
                    {if $blog_post}
                        ...
                        <div class="post-details">
                            <div class="blog-extra">
                                <div class="ybc-blog-latest-toolbar">
                                    {if $show_views}                  
                                        <span title="{l s='Page views' d='Shop.Theme.Actions'}" class="ybc-blog-latest-toolbar-views">
                                    ...
                                    {/if} 
                                    {if $allow_like}
                                        <span title="{if $likedPost}{l s='Liked' d='Shop.Theme.Actions'}{else}{l s='Like this post' d='Shop.Theme.Actions'}{/if}" class="ybc-blog-like-span ybc-blog-like-span-{$blog_post.id_post|intval} {if $likedPost}active{/if}"  data-id-post="{$blog_post.id_post|intval}">
                                            <span class="ben_{$blog_post.id_post|intval}">{$blog_post.likes|intval}</span>
                                            <span class="blog-post-like-text blog-post-like-text-{$blog_post.id_post|intval}"><span>{l s='Liked' d='Shop.Theme.Actions'}</span></span>
                                        </span>  
                                    {/if}
                                    {if $allow_rating && $everage_rating}                      
                                        <div class="blog_rating_wrapper" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">                            
                                            {if $total_review}
                                                <span title="{l s='Comments' d='Shop.Theme.Actions'}" class="blog_rating_reviews">
                                                     <span class="total_views" itemprop="reviewCount">{$total_review|intval}</span>
                                                     <span>
                                                        {if $total_review != 1}
                                                            {l s='Reviews' d='Shop.Theme.Actions'}
                                                        {else}
                                                            {l s='Review' d='Shop.Theme.Actions'}
                                                        {/if}
                                                    </span>
                                                </span>
                                            {/if}
                                            <div title="{l s='Everage rating' d='Shop.Theme.Actions'}" class="ybc_blog_free_review">
                                                <span>{l s='Rating: ' d='Shop.Theme.Actions'}</span> 
                                    ...
                                    {if $show_date}
                                        ...
                                        <span class="post-date">
                                            {l s='Posted on' d='Shop.Theme.Actions'}:
                                    ...
                                    {if $show_author && ($blog_post.firstname || $blog_post.lastname)}
                                        <div class="author-block">
                                            <span class="post-author-label">{l s='By: ' d='Shop.Theme.Actions'}</span>
                                ...
                                {if $use_google_share || $use_facebook_share || $use_twitter_share}
                                    <div class="blog-extra-item blog-extra-facebook-share">
                                        ...
                                        {if $use_twitter_share}
                                            <div class="ybc_blog_free_button_share">
                                                <a href="https://twitter.com/share" class="twitter-share-button" data-url="{$post_url|escape:'html':'UTF-8'}">{l s='Tweet' d='Shop.Theme.Actions'}</a>
                                                {literal}
                            ...
                            <div class="extra_tag_cat">
                                {if $show_tags && $blog_post.tags}
                                    <div class="ybc-blog-tags">
                                        ...
                                        <span class="be-label">
                                            {if $totalTag > 1}{l s='Tags' d='Shop.Theme.Actions'}
                                            {else}{l s='Tag' d='Shop.Theme.Actions'}{/if}: 
                                        </span>
                            ...
                            {if $display_related_products && $blog_post.products}
                                <div id="ybc-blog-related-products" class="">
                                    <h4 class="title_blog">
                                        {if count($blog_post.products) > 1}{l s='Related products ' d='Shop.Theme.Actions'}
                                        {else}{l s='Related product' d='Shop.Theme.Actions'}{/if}
                                    </h4>
                                                        ...
                                                        <div class="right-block">
                                                            ...
                                                            <div class="blog-product-extra content_price">
                                                                {if $product.price!=$product.old_price}
                                                                    <span class="bp-price-old old-price"><span class="bp-price-old-label">{l s='Old price: ' d='Shop.Theme.Actions'}</span><span class="bp-price-old-display">{$product.old_price|escape:'html':'UTF-8'}</span></span>
                                                                {/if}
                                                                <span class="bp-price price product-price"><span class="bp-price-label">{l s='Price:  ' d='Shop.Theme.Actions'}</span><span class="bp-price-display">{$product.price|escape:'html':'UTF-8'}</span></span>
                                                                {if $product.price!=$product.old_price}
                                                                    <span class="bp-percent price-percent-reduction"><span class="bp-percent-label">{l s='Discount: ' d='Shop.Theme.Actions'}</span><span class="bp-percent-display">-{$product.discount_percent|escape:'html':'UTF-8'}{l s='%' d='Shop.Theme.Actions'}</span></span>
                                                                    <span class="bp-save"><span class="bp-save-label">{l s='Save up: ' d='Shop.Theme.Actions'}</span><span class="bp-save-display">-{$product.discount_amount|escape:'html':'UTF-8'}</span></span>
                                                                {/if}
                                                            </div>
                            ...
                            <div class="ybc-blog-wrapper-comment">          
                                {if $allowComments}
                                    <div class="ybc_comment_form_blog">
                                        <h4 class="title_blog">{l s='Leave a comment' d='Shop.Theme.Actions'}</h4>
                                        <div class="ybc-blog-form-comment">                   
                                                ...
                                                <form action="{$blogCommentAction|escape:'html':'UTF-8'}" method="post">
                                                    {if !$hasLoggedIn} 
                                                        <div class="blog-comment-row blog-name">
                                                            <label for="bc-name">{l s='Name' d='Shop.Theme.Actions'}</label>
                                                        ...
                                                        <div class="blog-comment-row blog-email">
                                                            <label for="bc-email">{l s='Email' d='Shop.Theme.Actions'}</label>
                                                    ...
                                                    <div class="blog-comment-row blog-title">
                                                        <label for="bc-subject">{l s='Subject ' d='Shop.Theme.Actions'}</label>
                                                    ...
                                                    <div class="blog-comment-row blog-content-comment">
                                                        <label for="bc-comment">{l s='Comment ' d='Shop.Theme.Actions'}</label>
                                                        ...
                                                        <div class="blog-rate-capcha">
                                                            {if $allow_rating}                            
                                                                <div class="blog-rate-post">
                                                                    <label>{l s='Rating: ' d='Shop.Theme.Actions'}</label>
                                                            ...
                                                            {if $use_capcha}
                                                                <div class="blog-capcha">
                                                                    <label for="bc-capcha">{l s='Security code: ' d='Shop.Theme.Actions'}</label>
                                                                    <span class="bc-capcha-wrapper">
                                                                        ...
                                                                        <span id="ybc-blog-capcha-refesh" title="{l s='Refresh code' d='Shop.Theme.Actions'}">{*l s='Refresh code'*}</span>
                                                                    </span>
                                                                </div>
                                                            {/if}
                                                        </div>
                                                    ...
                                                    <div class="blog-submit">
                                                        <input class="button" type="submit" value="{l s='Submit Comment' d='Shop.Theme.Actions'}" name="bcsubmit" />
                                                    </div>       
                                                    </div>                
                                            ...
                                            {else}
                                                <p class="alert alert-warning">{l s='Log in to post comments' d='Shop.Theme.Actions'}</p>
                                            {/if}
                                        </div> 
                                    </div>
                                    {if count($comments)}
                                        ...
                                        <ul class="blog-comments-list">
                                            {foreach from=$comments item='comment'}
                                                    ...
                                                    <div class="ybc-blog-detail-comment">
                                                        ...
                                                        {if $comment.name}<span class="comment-by">{l s='By : ' d='Shop.Theme.Actions'}<b>{ucfirst($comment.name)|escape:'html':'UTF-8'}</b></span>{/if}
                                                        <span class="comment-time"><span>{l s='On' d='Shop.Theme.Actions'} </span>{date($date_format,strtotime($comment.datetime_added))|escape:'html':'UTF-8'}</span>
                                                        ...
                                                        {if $allow_report_comment}
                                                            {if !($reportedComments && is_array($reportedComments) && in_array($comment.id_comment, $reportedComments))}
                                                                <span class="ybc-block-comment-report comment-report-{$comment.id_comment|intval}" rel="{$comment.id_comment|intval}"><i class="fa fa-bolt" aria-hidden="true" title="{l s='Report this comment as abuse' d='Shop.Theme.Actions'}"></i></span>
                                                            {/if}
                                                        {/if}
                                                        ...
                                                        {if $comment.reply}<p class="comment-reply">
                                                            {if $comment.elastname || $comment.efirstname}
                                                                <span class="ybc-blog-replied-by">
                                                                    {l s='Replied by : ' d='Shop.Theme.Actions'}
                        ...
                        {else}
                            <p class="warning">{l s='No posts found' d='Shop.Theme.Actions'}</p>
                        {/if}
                        {if $blog_post.related_posts}
                            <div class="ybc-blog-related-posts ybc_blog_free_related_posts_type_{if $blog_related_posts_type}{$blog_related_posts_type|escape:'html':'UTF-8'}{else}default{/if}">
                                <h4 class="h1 products-section-title text-uppercase">
                                    <span><i class="fa fa-pencil-square-o"></i>{l s='Related posts' d='Shop.Theme.Actions'}</span>
                                </h4>
                                                        ...
                                                        {if $allow_like}
                                                            <span class="ybc-blog-like-span ybc-blog-like-span-{$rpost.id_post|intval} {if isset($rpost.liked) && $rpost.liked}active{/if}"  data-id-post="{$rpost.id_post|intval}">                        
                                                                ...
                                                                <span class="blog-post-like-text blog-post-like-text-{$rpost.id_post|intval}">
                                                                    {l s='Liked' d='Shop.Theme.Actions'}
                                                                </span>
                                                            </span>  
                                                        {/if}
                                                        {if $allowComments}
                                                            <span class="ybc-blog-latest-toolbar-comments">{$rpost.comments_num|intval}
                                                                {if $rpost.comments_num!=1}
                                                                    <span>{l s='comments' d='Shop.Theme.Actions'}</span>
                                                                {else}
                                                                    <span>{l s='comment' d='Shop.Theme.Actions'}</span>
                                                                {/if}
                                                            </span> 
                                                        {/if}
                                                    </div>
                ...
                {else}
                    <p class="alert alert-warning">{l s='This blog post is not available' d='Shop.Theme.Actions'}</p>
                {/if}
              {/block}
            </div>
          {/block}
