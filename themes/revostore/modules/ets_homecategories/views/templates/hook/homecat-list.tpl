	...
	{if $ETS_HOMECAT_ENBLE_ALL_PRODUCT_TAB || $ETS_HOMECAT_DISPLAY_SUB && $categories}
        ...
        {if $ETS_HOMECAT_ENBLE_ALL_PRODUCT_TAB}
            <li class="is_parent_cat_li is_parent_cat_li_all col-xs-12 col-sm-12" data-id-category="all">
                <span data-id-category="all" class="{if !$ETS_HOMECAT_OPEN_CAT_BY_LINK}homecat_ajax_tab_list homecat_ajax_tab_list_all{/if} is_parent_cat homecat_tab_name homcat_tab_all">{l s='All products' d='Shop.Theme.Actions'}</span>
